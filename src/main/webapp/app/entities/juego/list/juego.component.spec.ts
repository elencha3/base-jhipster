...
describe('Juego Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'juego', component: JuegoComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.juegos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
